...
if do_indoor
    ...
    for i = indoor_set_lst
        ...
        orig_img_dir = [near_indoor_dir, 'set', num2str(i), '/segs/img_left.png']
        xx = xx + 1;
        orig_img = imresize(imread(orig_img_dir),[64,64]);
...
if do_outdoor
    ...
    for i = near_outdoor_set_lst
        ...
        dct_dir = [near_outdoor_dir, 'set', num2str(i), '/jpeg_res/'];
        wavelet_dir = [near_outdoor_dir, 'set', num2str(i), '/wavelet_res/']
        tri1_dir = [near_outdoor_dir, 'set', num2str(i), '/tri1_res/']
        tri2_dir = [near_outdoor_dir, 'set', num2str(i), '/tri2_res/']
  %      tri3_dir = [near_outdoor_dir, 'set', num2str(i), '/tri3_res/']
...
if do_building
    ...
    for i = buildings_set_lst
        ...
        tri1_dir = [buildings_dir, 'set', num2str(i), '/tri1_res/']
        tri2_dir = [buildings_dir, 'set', num2str(i), '/tri2_res/']
  %      tri3_dir = [near_outdoor_dir, 'set', num2str(i), '/tri3_res/']
